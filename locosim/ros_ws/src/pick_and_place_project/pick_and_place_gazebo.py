...
class PickAndPlaceController(BaseControllerFixed):
    ...
    def __init__(self):
        ...
        self.object_names = sorted(conf.objects.keys(), 
                                   key=lambda x: conf.objects[x]['priority'])
        self.grasping = False
    ...
    def loadModelAndPublishers(self):
        ...
        self.sub_model_states = ros.Subscriber("/gazebo/model_states", ModelStates,
                                                callback=self._receive_model_states,
                                                queue_size=1)
    ...
    def start_trajectory(self, target_pos, duration=2.0):
        ...
        self.traj_start_pos = self.robot.framePlacement(self.q, self.frame_ee, True).translation.copy()
    ...
    def controlLoop(self):
        ...
        J6 = self.robot.frameJacobian(self.q, self.frame_ee, False, 
